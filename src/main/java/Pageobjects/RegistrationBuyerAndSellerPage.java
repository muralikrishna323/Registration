...
public class RegistrationBuyerAndSellerPage {
    ...
    By RegisterforTheSeller=By.xpath("//label[@for='true']//span[@class='radio-checkmark']");		
	...
	By NameOnTheCard1= By.xpath("(//input[@placeholder='Name on the Card'])[2]");         
	By CardNumber1=By.cssSelector("#root > form > span:nth-child(4) > div > div.CardNumberField-input-wrapper > span > input");
	By ExpirationDate1=By.xpath("//*[@id=\"root\"]/form/span[2]/span/input");
	By CVCCVVNumber1=By.xpath("//*[@id=\"root\"]/form/span[2]/span/input");
	By PopupAlert1=By.xpath("//button[normalize-space()='OK']");
	By MembershipName=By.xpath("/html[1]/body[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[2]/div[1]/div[2]/div[1]/div[1]/form[1]/div[6]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/form[1]/label[1]/input[1]");
	...
	public RegistrationBuyerAndSellerPage(WebDriver driver) {
		this.driver=driver;
	}
	...
	public WebElement getRegisterforTheSeller() {
		return driver.findElement(RegisterforTheSeller);
		}
	...
	public WebElement getPopupAlert1() {
		return driver.findElement(PopupAlert1);
		}
