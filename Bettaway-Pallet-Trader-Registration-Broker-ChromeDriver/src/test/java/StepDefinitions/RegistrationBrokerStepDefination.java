...
public class RegistrationBrokerStepDefination {
	...
	public WebDriver initializeDriver() {
		...
		System.setProperty("webdriver.chrome.driver","C:\\Users\\Mobile Programming\\eclipse-workspace\\Bettaway-Pallet-Trader-Registration-Broker-ChromeDriver\\Drivers\\chromedriver.exe");
	...
	public void user_navigates_to_the_website_myapp_pallettrader_com() throws Throwable {
		...
		driver.get("http://staging.pallettrader.com/#/");
		driver.findElement(By.xpath("//input[1]")).sendKeys("PalletWorld");
		driver.findElement(By.xpath("//input[@type='password']")).sendKeys("NoTimeForFun@2021");
