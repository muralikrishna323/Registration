...
public class TraderRegistrationSellerDefination {
	...
	System.setProperty("webdriver.edge.driver","C:\\Users\\Mobile Programming\\eclipse-workspace\\Bettaway-Pallet-Trader-Registration-Seller-MicrosoftEdge\\Drivers\\msedgedriver.exe");
	...
	PageObjects2.RegistrationSellerPage s=new RegistrationSellerPage(driver);
    s.getEmail().sendKeys("1188n@mailinator.com");
	}
