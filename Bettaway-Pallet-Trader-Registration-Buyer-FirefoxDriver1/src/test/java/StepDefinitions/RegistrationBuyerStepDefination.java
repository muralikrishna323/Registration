...
public class RegistrationBuyerStepDefination {
	...
	System.setProperty("webdriver.gecko.driver","C:\\Users\\Mobile Programming\\eclipse-workspace\\Bettaway-Pallet-Trader-Registration-Buyer-FirefoxDriver1\\Drivers\\geckodriver.exe");
   ...
   b.getUsername().sendKeys("AutomationTester");
	...
	PageObjects1.RegistrationBuyerPage b=new RegistrationBuyerPage(driver);
   b.getEmail().sendKeys("1977s@mailinator.com");
	}
