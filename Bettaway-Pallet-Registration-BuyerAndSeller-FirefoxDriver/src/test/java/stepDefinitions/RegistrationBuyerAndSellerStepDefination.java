...
public class RegistrationBuyerAndSellerStepDefination {
	...
	System.setProperty("webdriver.gecko.driver","C:\\Users\\Mobile Programming\\eclipse-workspace\\Bettaway-Pallet-Registration-BuyerAndSeller-FirefoxDriver\\Drivers\\geckodriver.exe");
...
public void user_enter_the_valid_email_id() {
	PageObjects3.RegistrationBuyerAndSellerPage both=new RegistrationBuyerAndSellerPage(driver);
	both.getEmail().sendKeys("2016n@mailinator.com");
}
...
@When(": User Enter the UploadCreditReferences")
public void user_enter_the_upload_credit_references() {
	PageObjects3.RegistrationBuyerAndSellerPage both=new RegistrationBuyerAndSellerPage(driver);
	both.getUploadCreditReferences().sendKeys("C:\\Users\\Mobile Programming\\OneDrive\\Desktop\\Credit References.jpeg");
}
