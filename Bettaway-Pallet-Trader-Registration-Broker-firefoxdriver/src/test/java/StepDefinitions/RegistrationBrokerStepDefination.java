...
public class RegistrationBrokerStepDefination {
	...
	public WebDriver initializeDriver() {
		...
		System.setProperty("webdriver.gecko.driver","C:\\Users\\Mobile Programming\\eclipse-workspace\\Bettaway-Pallet-Trader-Registration-Broker-firefoxdriver\\Drivers\\geckodriver.exe");
	...
	public void user_enter_the_valid_email_id() {
		RegistrationBrokerPage r=new RegistrationBrokerPage(driver);  
		r.getEmail().sendKeys("1977b@mailinator.com");  
	}
