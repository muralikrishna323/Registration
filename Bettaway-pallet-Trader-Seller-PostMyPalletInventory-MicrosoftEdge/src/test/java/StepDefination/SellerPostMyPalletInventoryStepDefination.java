...
WebDriver driver;
	...
	public WebDriver initializeDriver() {
		...
		System.setProperty("webdriver.edge.driver","C:\\Users\\Mobile Programming\\eclipse-workspace\\Bettaway-pallet-Trader-Seller-PostMyPalletInventory-MicrosoftEdge\\drivers\\msedgedriver.exe");
...
i.getSizeDropdown().click();
	...
	@When(": User Click on the  Grade drop down")
	public void user_click_on_the_grade_drop_down() throws InterruptedException {
	   Thread.sleep(3000);
	
	driver.findElement(By.xpath("//body[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[2]/div[2]/form[1]/div[2]/div[5]/div[4]/div[2]/div[1]/div[1]/div[1]/div[2]/div[1]")).click();
	
	}
	@When(": User Select  the Grade")
	public void user_select_the_grade() throws InterruptedException {
		 Thread.sleep(3000);
	
		 driver.findElement(By.xpath("//div[text()='Grade A']")).click();
	}
...
// i.getHeatTreatedCheckbox().click();
		WebElement element1 = driver.findElement(By.xpath("//label[normalize-space()='Heat Treated']"));
		JavascriptExecutor executor1 = (JavascriptExecutor) driver;
		executor1.executeScript("arguments[0].click();", element1);
