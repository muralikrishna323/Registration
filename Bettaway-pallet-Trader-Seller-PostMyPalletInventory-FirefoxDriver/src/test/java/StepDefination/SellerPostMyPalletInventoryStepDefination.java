...
WebDriver driver;
	...
	public WebDriver initializeDriver() {
		...
		System.setProperty("webdriver.gecko.driver","C:\\Users\\Mobile Programming\\eclipse-workspace\\Bettaway-pallet-Trader-Seller-PostMyPalletInventory-FirefoxDriver\\drivers\\geckodriver.exe");
...
i.getProductImages().sendKeys("C:\\Users\\Mobile Programming\\eclipse-workspace\\dummy\\Resources\\pallet1.png");
	...
	public void user_select_on_the_material_type() {
	 WebElement element1 = driver.findElement(By.xpath("//label[normalize-space()='Plastic']"));
	JavascriptExecutor executor1 = (JavascriptExecutor) driver;
	executor1.executeScript("arguments[0].click();", element1);
}
	...
	Thread.sleep(3000);
		WebElement element1 = driver.findElement(By.xpath("//label[normalize-space()='New']"));
		JavascriptExecutor executor1 = (JavascriptExecutor) driver;
		executor1.executeScript("arguments[0].click();", element1);
		Thread.sleep(3000);
	}
...
i.getUploadSpecificationFile().sendKeys("C:\\Users\\Mobile Programming\\eclipse-workspace\\Bettaway-pallet-Trader-Seller-PostMyPalletInventory-ChromeDriver\\Resources\\Specification.docx");
	...
	public void user_enter_on_the_delivery_requirements() {
	  WebElement element41 = driver.findElement(By.xpath("//label[normalize-space()='No, must be picked up']"));
...
//i.getBusinessDayDropdown().click();  
		//Thread.sleep(5000);
		//WebElement element41 = driver.findElement(By.xpath("//div[contains(@class,'css-os3nnz-control')]//div[contains(@class,'css-1wy0on6')]"));
		//JavascriptExecutor executor41 = (JavascriptExecutor) driver;
		//executor41.executeScript("arguments[0].click();", element41);
		WebElement elementDropDownOne = driver.findElement(By.xpath("//input[@name='isDeliveryAvailable']"));
		Thread.sleep(10000);
		JavascriptExecutor js = (JavascriptExecutor) driver;
		js.executeScript("arguments[0].scrollIntoView(true);", elementDropDownOne);
		Thread.sleep(10000);
		// (//div[@class=' css-1b4q2jw'])[position()=1]
		WebElement manageAccount1 = driver.findElement(By.xpath("//div[contains(@class,'css-os3nnz-control')]//div[contains(@class,'css-1wy0on6')]"));
		Actions actions1 = new Actions(driver);
		actions1.moveToElement(manageAccount1);
...
@When(": User Enter on the Bid Close Date")
	...
	public void user_enter_on_the_recurrence_pattern_and_click_on_the_daily_or_weekly_or_monthly_radio_button() {
      ...
      i.getweeklyRadioButton().click();
		...
		//driver.findElement(By.xpath("//label[normalize-space()='Weekly']")).click();
		
		}
	
	@When(": User Select  the Monday")
	public void user_select_the_monday() {
  ...
  i.getMonday().click();
	...
	public void user_select_the_tuesday() {
		//driver.findElement(By.xpath("//label[normalize-space()='Tuesday']")).click();
		SellerPostMyPalletInventoryPage i=new SellerPostMyPalletInventoryPage(driver);
  i.getTuesday().click();
	
	}
	@When(": User Select  the Wednesday")
	public void user_select_the_wednesday() {
		SellerPostMyPalletInventoryPage i=new SellerPostMyPalletInventoryPage(driver);

		i.getWednesday().click();
		
		
		//driver.findElement(By.xpath("//label[normalize-space()='Wednesday']")).click();
	}
	
	@When(": User Select  the Thursday")
	public void user_select_the_thursday() {
	...
	public void user_select_the_friday() {
		
		SellerPostMyPalletInventoryPage i=new SellerPostMyPalletInventoryPage(driver);
   i.getFriday().click();
		//driver.findElement(By.xpath("//label[normalize-space()='Friday']")).click();
	}
...
@When(": User Click  on the  Submit Button")
   ...
   i.getSubmitButton().click();
	...
	public void user_enter_on_the_my_community_groups() {
		//driver.findElement(By.xpath("//label[normalize-space()='Post to a Group in My Community']")).click();

	
	
		WebElement element94 = driver.findElement(By.xpath("//label[normalize-space()='Post to a Group in My Community']"));
		JavascriptExecutor executor94 = (JavascriptExecutor) driver;
		executor94.executeScript("arguments[0].click();", element94);	
	
	}
	@When(": User Click on the My Community Groups Dropdown")
	public void user_click_on_the_my_community_groups_dropdown() throws InterruptedException {
		//Thread.sleep(5000);
		
		//driver.findElement(By.xpath("//div[@class='select__indicator select__dropdown-indicator css-tlfecz-indicatorContainer']")).click();
   
		WebElement elementDropDownOne = driver.findElement(By.xpath("//p[normalize-space()='My Community Groups']"));
		Thread.sleep(10000);
		JavascriptExecutor js = (JavascriptExecutor) driver;
		js.executeScript("arguments[0].scrollIntoView(true);", elementDropDownOne);
		Thread.sleep(10000);
		// (//div[@class=' css-1b4q2jw'])[position()=1]
		WebElement manageAccount1 = driver.findElement(By.xpath("//div[@class='select__indicator select__dropdown-indicator css-tlfecz-indicatorContainer']"));
		Actions actions1 = new Actions(driver);
		actions1.moveToElement(manageAccount1);
		actions1.click().build().perform();
		Thread.sleep(2000);
	...
	public void user_select_the_group() throws InterruptedException {
		...
		SellerPostMyPalletInventoryPage i=new SellerPostMyPalletInventoryPage(driver);
         i.getSelectTheGroup().click();
		
		
		
		//driver.findElement(By.xpath("//div[text()='T@1234']")).click();
