...
public class RegistrationBuyerAndSellerStepDefination {
	...
	System.setProperty("webdriver.edge.driver","C:\\Users\\Mobile Programming\\eclipse-workspace\\Bettaway-Pallet-Registration-BuyerAndSeller-MicrosoftEdge\\Drivers\\msedgedriver.exe");
...
public void user_enter_the_valid_email_id() {
	PageObjects3.RegistrationBuyerAndSellerPage both=new RegistrationBuyerAndSellerPage(driver);
	both.getEmail().sendKeys("2016m@mailinator.com");
}
...
public void user_enter_the_valid_card_number() {
	driver.switchTo().frame(driver.findElement(By.xpath("//*[@id=\"root\"]/div/div/div/div/div[2]/div[2]/div/div[2]/div/div/form/div[4]/div/div[2]/div/div/div/div/div[1]/form/label[2]/div/div/iframe")));
