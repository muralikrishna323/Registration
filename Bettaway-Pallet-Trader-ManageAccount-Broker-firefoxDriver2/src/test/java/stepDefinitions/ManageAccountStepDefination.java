...
WebDriver driver;
	...
	public WebDriver initializeDriver() {
		...
		System.setProperty("webdriver.gecko.driver","C:\\Users\\Mobile Programming\\eclipse-workspace\\Bettaway-Pallet-Trader-ManageAccount-Broker-firefoxDriver2\\drivers\\geckodriver.exe");
	...
	public void user_enter_the_valid_email_id() throws InterruptedException {
		Thread.sleep(2000);
		pageObjects.ManageAccountPage M=new ManageAccountPage(driver);
	M.getEmailId().sendKeys("1901l@mailinator.com");
	}
	...
	public void user_enter_the_account_details_and_click_on_the_edit_profile_picture() throws InterruptedException {
		pageObjects.ManageAccountPage M=new ManageAccountPage(driver);
    driver.findElement(By.xpath("//input[@id='getFile']")).sendKeys("C:\\Users\\Mobile Programming\\eclipse-workspace\\Bettaway-Pallet-Trader-ManageAccount-Broker-firefoxDriver2\\Resourses\\Broker.jpeg");
		Thread.sleep(2000);
	...
	//	@When(": User  Click on OK button inside alert pop-up window3")
		...
		public void user_enter_the_marketplace_search_radius_preference() throws InterruptedException {
			...
			WebElement elementDropDownOne = driver.findElement(By.xpath("//input[@name='deliveryWindowBegin']"));
			Thread.sleep(10000);
			JavascriptExecutor js = (JavascriptExecutor) driver;
			js.executeScript("arguments[0].scrollIntoView(true);", elementDropDownOne);
			Thread.sleep(10000);
			// (//div[@class=' css-1b4q2jw'])[position()=1]
			WebElement manageAccount1 = driver.findElement(By.xpath("(//div[@class=' css-1b4q2jw'])[position()=1]"));
		...
		public void user_enter_the_upload_the_exempt_form() throws InterruptedException {
			 Thread.sleep(2000);
			pageObjects.ManageAccountPage M=new ManageAccountPage(driver);
	           M.getUploadTheExemptForm().sendKeys("C:\\Users\\Mobile Programming\\eclipse-workspace\\Bettaway-Pallet-Trader-ManageAccount-Broker-firefoxDriver2\\Resourses\\EXEMPT FORM.docx");
	      }
