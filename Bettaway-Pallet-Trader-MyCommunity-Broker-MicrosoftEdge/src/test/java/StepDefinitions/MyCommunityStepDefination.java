...
public class MyCommunityStepDefination {
	...
	public WebDriver initializeDriver() {
		...
		System.setProperty("webdriver.edge.driver","C:\\Users\\Mobile Programming\\eclipse-workspace\\Bettaway-Pallet-Trader-MyCommunity-Broker-MicrosoftEdge\\Drivers\\msedgedriver.exe");
	...
	mc.getEmailId().sendKeys("1901a@mailinator.com");
	}
	@When(": User Enter the valid Password")
	public void user_enter_the_valid_password() {
		pageObjects.MyCommunityPage mc=new MyCommunityPage(driver);
		mc.getPassword().sendKeys("Automation@123");
	}
