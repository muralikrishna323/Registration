...
public class MyCommunityStepDefination {
	...
	public WebDriver initializeDriver() {
		...
		System.setProperty("webdriver.chrome.driver","C:\\Users\\Mobile Programming\\eclipse-workspace\\Bettaway-Pallet-Trader-MyCommunity-ChromeDriver\\Drivers\\chromedriver.exe");
	...
	public void user_navigates_to_the_website_myapp_pallettrader_com() {
		...
		//driver.get("https://stage-myapp.pallettrader.com/#/");
	...
	mc.getEmailId().sendKeys("1977c@mailinator.com");
	}
	...
	public void user_click_on_ok_button_inside_alert_pop_up_window6() throws InterruptedException {
		Thread.sleep(2000);
		pageObjects.MyCommunityPage mc=new MyCommunityPage(driver);
   mc.getpopupwindow6().click(); 
	...
	public void user_click_on_the_create_group_button() throws InterruptedException {
		Thread.sleep(2000);
		pageObjects.MyCommunityPage mc=new MyCommunityPage(driver);
	...
	public void user_click_on_the_camera_icon_and_upload_the_image() throws InterruptedException {
		Thread.sleep(2000);
		pageObjects.MyCommunityPage mc=new MyCommunityPage(driver);
   mc.getUploadImage1().sendKeys("C:\\Users\\Mobile Programming\\eclipse-workspace\\Bettaway-Pallet-Trader-MyCommunity-Broker-ChromeDriver\\Resources\\group.png"); 
	...
	public void user_click_on_the_group_name() throws InterruptedException {
		Thread.sleep(2000);
		pageObjects.MyCommunityPage mc=new MyCommunityPage(driver);
   mc.getGroupName().sendKeys("T@1234");
	}
	@When(": User Click on the Description")
	public void user_click_on_the_description() throws InterruptedException {
		Thread.sleep(2000);
		pageObjects.MyCommunityPage mc=new MyCommunityPage(driver);
   mc.getDescription().sendKeys("Testing Group for testing reasons"); 
	...
	public void user_enter_the_group_privacy_settings() throws InterruptedException {
		Thread.sleep(2000);
