...
public class RegistrationBuyerStepDefination {
	...
	System.setProperty("webdriver.edge.driver","C:\\Users\\Mobile Programming\\eclipse-workspace\\Bettaway-Pallet-Trader-Registration-Buyer-MicrosoftEdge\\Drivers\\msedgedriver.exe");
   ...
   b.getUsername().sendKeys("AutomationTester");
	...
	PageObjects1.RegistrationBuyerPage b=new RegistrationBuyerPage(driver);
   b.getEmail().sendKeys("2022f@mailinator.com");
	}
