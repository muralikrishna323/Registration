...
WebDriver driver;
	...
	public WebDriver initializeDriver() {
		...
		System.setProperty("webdriver.chrome.driver","C:\\Users\\Mobile Programming\\eclipse-workspace\\Bettaway-Pallet-Trader-ManageAccount-Broker-ChromeDriver2\\drivers\\chromedriver.exe");
	...
	public void user_enter_the_valid_email_id() throws InterruptedException {
		Thread.sleep(2000);
		pageObjects.ManageAccountPage M=new ManageAccountPage(driver);
	M.getEmailId().sendKeys("1901k@mailinator.com");
	}
