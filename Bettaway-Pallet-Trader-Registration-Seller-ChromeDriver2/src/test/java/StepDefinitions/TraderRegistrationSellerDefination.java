...
public class TraderRegistrationSellerDefination {
	...
	System.setProperty("webdriver.chrome.driver","C:\\Users\\Mobile Programming\\eclipse-workspace\\Bettaway-Pallet-Trader-Registration-Seller-ChromeDriver2\\Drivers\\chromedriver.exe");
	...
	PageObjects2.RegistrationSellerPage s=new RegistrationSellerPage(driver);
    s.getEmail().sendKeys("1978e@mailinator.com");
	}
