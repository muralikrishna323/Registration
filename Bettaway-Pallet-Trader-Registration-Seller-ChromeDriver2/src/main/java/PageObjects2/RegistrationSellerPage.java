...
public class RegistrationSellerPage {
	...
	By MembershipName=By.xpath("//div[@class='text-left mt-4 mb-2']//div//div[contains(@class,'paymentWrapper')]//div[@class='payment']//div//input[@placeholder='Name on the Card']");
